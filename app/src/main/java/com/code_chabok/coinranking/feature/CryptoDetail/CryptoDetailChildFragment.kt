 ...
 * Use the [CryptoDetailChildFragment.newInstance] factory method to
...
class CryptoDetailChildFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CryptoDetailChildFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CryptoDetailChildFragment().apply {
